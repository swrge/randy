...
use rkyv::{
    Archive, Archived, Serialize, option::ArchivedOption, rancor::Source, ser::writer::Buffer,
    traits::NoUndef, util::Align, with::Map,
};
...
pub struct CachedUser {
    // randy's types don't implement rkyv traits so `redlight::rkyv_util`
