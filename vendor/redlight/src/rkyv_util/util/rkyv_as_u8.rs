...
/// ```
///
/// [`IntegrationExpireBehavior`]: randy_model::guild::IntegrationExpireBehavior
/// [`PermissionOverwriteType`]: randy_model::channel::permission_overwrite::PermissionOverwriteType
/// [`StickerType`]: randy_model::channel::message::sticker::StickerType
pub struct RkyvAsU8;
...
mod tests {
    ...
    use randy_model::guild::IntegrationExpireBehavior;
